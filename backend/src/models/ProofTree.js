...
const proofTreeNodeSchema = new mongoose_1.Schema({
...
const proofTreeSchema = new mongoose_1.Schema({
...
exports.ProofTree = mongoose_1.default.model("ProofTree", proofTreeSchema);
